...
# THIS VERSION TAKES THE MEAN GENE EXPRESSION VALUES.
############################################
...
p <- p + scale_color_manual(name="Gene Set", values=c(
...
### VARIABLE
p <- p + labs(y="Mean mean brain expression")
p

#main1_rnaseq_release_v1_mean_NO_NEAREST-9x6.pdf
